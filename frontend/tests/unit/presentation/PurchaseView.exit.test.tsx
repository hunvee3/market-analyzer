...
describe('PurchaseView exit behavior', () => {
  it('Given no assignments, When Exit clicked, Then onClose is called directly', async () => {
  ...
  it('Given assignments exist, When Exit clicked, Then confirmation dialog appears', async () => {
    const user = userEvent.setup()
    const onClose = vi.fn()
    const store = createStore()
